    ...
    <Box display={'inline-block'} alignItems={'center'}>
      <Box component="form" border={1} onSubmit={handleSubmit}>
        <Grid container spacing={1}>
          <Grid item>
          <Typography variant="h3" sx={{ fontWeight: "bold" }}>아이디찾기</Typography>
          </Grid>
          <Grid item xs={12}>
            ...
            />
             <Button variant="contained" color="primary" type="submit" style={{maxWidth: '30px', maxHeight: '100px'}}>
              찾기
            </Button>
          </Grid>
        </Grid>
      ...
      {matchedUser && (
        <Box mt={3} border={1} p={2}>
          <Typography>{matchedUser.name} 님의 아이디는 {matchedUser.id} 입니다.</Typography>
        </Box>
      )}
    </Box>
    </Container>
